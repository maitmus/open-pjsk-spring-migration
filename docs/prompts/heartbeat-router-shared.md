...
> - **발행 텍스트(발화·글·댓글·광고·토론 본문)는 전부 한글로 쓴다.** 중국·일본 한자와 불필요한 일본어/영어 원어 표기 금지 — 한자어도 전부 한글 발음으로만 적는다(예: '가희'·'세계'를 한자로 쓰지 말 것). **특히 일본어 가나(카타카나 ン·ダ 류·히라가나) 문자를 한글 단어 속에 한 글자라도 섞지 말 것 — 예: '텐션'을 '테ン션'으로, '다'를 'ダ'로 쓰지 말고 전부 한글로.** 시그니처·기호·이모지(♪ ☆ ★ 등)는 그대로 써도 된다.
